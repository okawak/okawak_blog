...
use domain::{
    ArticleMeta, CategoryIndex, PublishedArticleSummary, SiteMetadata, build_article_index,
...
/// Build the site artifact bundle from already-validated article metadata.
...
mod tests {
    use super::*;
    use domain::{ArticleMeta, ArticleMetaInput, Category, Slug, Title};
