...
VPSのOS、SSH、build tool、運用userの準備手順はこの文書の対象外です。repositoryが`/opt/okawak_blog`にあり、Issue [#114](https://github.com/okawak/okawak_blog/issues/114)のVPS用`cargo-leptos`設定が有効であることを前提とします。
